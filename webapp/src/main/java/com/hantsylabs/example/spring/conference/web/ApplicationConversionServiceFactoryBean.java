...
public class ApplicationConversionServiceFactoryBean extends
	...
	public Converter<Conference, String> getConferenceToStringConverter() {
		return new org.springframework.core.convert.converter.Converter<Conference, java.lang.String>() {
			@Override
	...
	public Converter<Long, Conference> getIdToConferenceConverter() {
		return new org.springframework.core.convert.converter.Converter<java.lang.Long, Conference>() {
			@Override
	...
	public Converter<String, Conference> getStringToConferenceConverter() {
		return new org.springframework.core.convert.converter.Converter<java.lang.String, Conference>() {
			@Override
			public Conference convert(
					String id) {
	...
	public Converter<Signup, String> getSignupToStringConverter() {
		return new org.springframework.core.convert.converter.Converter<Signup, java.lang.String>() {
			@Override
	...
	public Converter<Long, Signup> getIdToSignupConverter() {
		return new org.springframework.core.convert.converter.Converter<Long, Signup>() {
			@Override
			public Signup convert(
					Long id) {
	...
	public Converter<String, Signup> getStringToSignupConverter() {
		return new org.springframework.core.convert.converter.Converter<java.lang.String, Signup>() {
			@Override
			public Signup convert(
					String id) {
				return getObject().convert(getObject().convert(id, Long.class),
