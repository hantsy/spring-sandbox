...
import com.hantsylabs.example.conference.config.HibernateConfig;
import com.hantsylabs.example.conference.model.Conference;

@RunWith(SpringJUnit4ClassRunner.class)
@ContextConfiguration(classes={HibernateConfig.class})
public class AnnotationConfigHibernate4ConferenceDaoImplTest {

	private static final Logger log = LoggerFactory
			.getLogger(AnnotationConfigHibernate4ConferenceDaoImplTest.class);
