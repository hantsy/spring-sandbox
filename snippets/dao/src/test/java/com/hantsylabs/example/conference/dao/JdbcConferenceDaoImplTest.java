...
import com.hantsylabs.example.conference.hibernate3.Hibernate3ConferenceDaoImpl;
import com.hantsylabs.example.conference.jdbc.JdbcConferenceDaoImpl;
import com.hantsylabs.example.conference.model.Conference;

@RunWith(SpringJUnit4ClassRunner.class)
@ContextConfiguration(locations = "classpath:/com/hantsylabs/example/conference/config/applicationContext-jdbc.xml")
public class JdbcConferenceDaoImplTest {

	private static final Logger log = LoggerFactory
			.getLogger(JdbcConferenceDaoImplTest.class);

	@Autowired
	JdbcConferenceDaoImpl conferenceDao;
