...
import com.hantsylabs.example.conference.jdbc.JdbcTemplateConferenceDaoImpl;
...
public class JdbcTemplateConferenceDaoImplTest {

	private static final Logger log = LoggerFactory
			.getLogger(JdbcTemplateConferenceDaoImplTest.class);

	@Autowired
	JdbcTemplateConferenceDaoImpl conferenceDao;
