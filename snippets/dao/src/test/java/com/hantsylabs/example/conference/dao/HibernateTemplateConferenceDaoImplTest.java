...
import com.hantsylabs.example.conference.hibernate3.HibernateTemplateConferenceDaoImpl;
import com.hantsylabs.example.conference.model.Conference;

@RunWith(SpringJUnit4ClassRunner.class)
@ContextConfiguration(locations = "classpath:/com/hantsylabs/example/conference/config/applicationContext-hibernate3.xml")
public class HibernateTemplateConferenceDaoImplTest {

	private static final Logger log = LoggerFactory
			.getLogger(HibernateTemplateConferenceDaoImplTest.class);

	@Autowired
	HibernateTemplateConferenceDaoImpl conferenceDao;
